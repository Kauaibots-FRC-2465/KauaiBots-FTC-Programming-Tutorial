...
class TranslationalTuner extends OpMode {
    ...
    public void start() {
        ...
        follower.setPose(testPath.getPose(0).withHeading(testPath.getHeadingGoal(0)));
    ...
    public void loop() {
        ...
        {
            follower.setPose(testPath.getPose(0).withHeading(testPath.getHeadingGoal(0)).withY(impulseDistance));
            follower.followPath(testPath);
        }
